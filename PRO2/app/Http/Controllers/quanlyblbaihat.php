...
Session_start();
class quanlyblbaihat extends Controller
{
    ...
    public function index()
     {
         ...
         $emp1 = emp_blbaihat::all();
         return view('admin.qlblbaihat.ql_blbaihat')->with('emp2',$emp1);
     }
    ...
    public function delete($id) 
    {
        ...
        $emps = emp_blbaihat::find($id);
        $emps->delete();

        return redirect('ql_blbaihat');
